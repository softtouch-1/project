...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($amount > 0) {
        ...
        $conn->query("INSERT INTO transactions (user_id, date, type, amount, status)
                      VALUES ($user_id, NOW(), 'إيداع', $amount, 'مكتمل')");

        $message = "✅ تم إيداع " . number_format($amount, 2) . " JOD بنجاح!";
        $success = true;
    } else {
        $message = "⚠ الرجاء إدخال مبلغ صالح.";
    }
}
?>
<!DOCTYPE html>
